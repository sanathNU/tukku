...
### Image Disclaimer
The image (`rust_pic.jpeg`) included in this repository was generated by a diffusion model (Google Gemini) and is provided for representation purposes only. Use of this image in other projects, especially for commercial purposes, is not permitted.

The rest of the code in this repository is open source and may be used in accordance with the WTFPL license. This restriction applies only to the AI-generated image.